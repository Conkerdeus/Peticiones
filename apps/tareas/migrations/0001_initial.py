...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tareas_tarea', (
            ...
            ('creada', self.gf('django.db.models.fields.related.ForeignKey')(related_name='Creada', to=orm['usuarios.Usuario'])),
            ('asignada', self.gf('django.db.models.fields.related.ForeignKey')(related_name='Asignada', to=orm['usuarios.Usuario'])),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('prioridad', self.gf('django.db.models.fields.CharField')(max_length=3)),
        ))
        db.send_create_signal(u'tareas', ['Tarea'])

        # Adding M2M table for field comentarios on 'Tarea'
        m2m_table_name = db.shorten_name(u'tareas_tarea_comentarios')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('tarea', models.ForeignKey(orm[u'tareas.tarea'], null=False)),
            ('comentario', models.ForeignKey(orm[u'comentarios.comentario'], null=False))
        ))
        db.create_unique(m2m_table_name, ['tarea_id', 'comentario_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field comentarios on 'Tarea'
        db.delete_table(db.shorten_name(u'tareas_tarea_comentarios'))
    ...
    models = {
        ...
        u'tareas.tarea': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'prioridad': ('django.db.models.fields.CharField', [], {'max_length': '3'}),
