...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Tarea.numero_prioridad'
        db.delete_column(u'tareas_tarea', 'numero_prioridad')

        # Adding field 'Tarea.orden_prioridad'
        db.add_column(u'tareas_tarea', 'orden_prioridad',
                      self.gf('django.db.models.fields.CharField')(max_length=1, null=True),
                      keep_default=False)


        # Changing field 'Tarea.color_prioridad'
        db.alter_column(u'tareas_tarea', 'color_prioridad', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

    def backwards(self, orm):
        # Adding field 'Tarea.numero_prioridad'
        db.add_column(u'tareas_tarea', 'numero_prioridad',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Tarea.orden_prioridad'
        db.delete_column(u'tareas_tarea', 'orden_prioridad')


        # Changing field 'Tarea.color_prioridad'
        db.alter_column(u'tareas_tarea', 'color_prioridad', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))
    ...
    models = {
        ...
        u'tareas.tarea': {
            'Meta': {'ordering': "['orden_prioridad']", 'object_name': 'Tarea'},
            'asignada': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'Asignada'", 'to': u"orm['usuarios.Usuario']"}),
            'color_prioridad': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True'}),
            ...
            'fecha_creacion': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'orden_prioridad': ('django.db.models.fields.CharField', [], {'max_length': '1', 'null': 'True'}),
