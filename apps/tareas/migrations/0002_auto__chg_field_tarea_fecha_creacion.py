...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'tareas_tarea', 'fecha_creacion', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Tarea.fecha_creacion'
        db.alter_column(u'tareas_tarea', 'fecha_creacion', self.gf('django.db.models.fields.DateField')())
