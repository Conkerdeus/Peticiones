...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tarea.status'
        db.alter_column(u'tareas_tarea', 'status', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'Tarea.prioridad'
        db.alter_column(u'tareas_tarea', 'prioridad', self.gf('django.db.models.fields.CharField')(max_length=15))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Tarea.status'
        db.alter_column(u'tareas_tarea', 'status', self.gf('django.db.models.fields.CharField')(max_length=3))

        # Changing field 'Tarea.prioridad'
        db.alter_column(u'tareas_tarea', 'prioridad', self.gf('django.db.models.fields.CharField')(max_length=3))
