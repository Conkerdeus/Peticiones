...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'usuarios_usuario', (
            ...
            ('username', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('es_directivo', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('es_programador', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('es_usuario', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
